        ...
        childs: [
          {
            ...
            icon: 'fa-table',
            label: 'Datasets',
            url: '/superset/tablemodelviews/list/?_flt_1_is_sqllab_view=y',
          },
          '-',
          {
            name: 'Databases',
            icon: 'fa-database',
            label: 'Databases',
            url: '/superset/databaseviews/list/',
          },
        ],
      },
      {
        ...
        icon: 'fa-bar-chart',
        label: 'Charts',
        url: '/superset/charts/list/',
      },
      {
        name: 'Dashboards',
        icon: 'fa-dashboard',
        label: 'Dashboards',
        url: '/superset/dashboards/list/',
      },
    ],
    brand: {
    ...
    navbar_right: {
      ...
      languages: {
        en: {
          flag: 'us',
          name: 'English',
          url: '/superset/lang/en',
        },
        it: {
          flag: 'it',
          name: 'Italian',
          url: '/superset/lang/it',
        },
      },
      show_language_picker: true,
      user_is_anonymous: false,
      user_info_url: '/superset/users/userinfo/',
      user_logout_url: '/superset/logout/',
      user_login_url: '/superset/login/',
      locale: 'en',
    },
    settings: [
      {
